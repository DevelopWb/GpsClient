...
public class AbFragment extends Fragment {
	...
	public void initLoadView() {
       ...
       // mLoadView.setBackgroundColor(Color.parseColor("#40000000"));
    ...
    public void mj_showLoadView(){
        ...
        mLoadView.setOnTouchListener(null);
        mLoadView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("majin","mLoadView---------");
            }
        });
        // 执行加载
        load(mLoadImageView);
